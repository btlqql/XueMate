...
> Extracted from `https://www.duolingo.com` on May 6, 2026
> 4290 elements analyzed
...
| Hex | HSL | Usage Count |
|-----|-----|-------------|
| `#3c3c3c` | hsl(0, 0%, 24%) | 7857 |
| `#777777` | hsl(0, 0%, 47%) | 268 |
| `#000000` | hsl(0, 0%, 0%) | 206 |
...
| Hex | Contexts | Count |
|-----|----------|-------|
| `#3c3c3c` | text, border | 7857 |
| `#777777` | text, border | 268 |
| `#000000` | text, border, background | 206 |
...
- **din-round** — used for all (4278 elements)
- **feather** — used for all (11 elements)
- **sans-serif** — used for all (1 elements)
...
- 3744 duplicate CSS declarations
...
1. **Install fonts:** Add `din-round` from Google Fonts or your font provider
